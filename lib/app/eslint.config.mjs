 ...
 *
 * So the files may be imported from exactly three places, and this block's
 ...
 * - **`prisma/seeds/**`** — a seed unit may reach a file directly.
 ...
 * is the half that can — it walks the graph and fails on any path from `app/`,
 * `components/` or the rest of `lib/` into `seed-input/` or a file. Neither
    ...
    'no-restricted-syntax': [
      'error',
      {
        ...
        message:
          ...
          'Only lib/app/content/seed-input/**, prisma/seeds/** and tests may import ' +
          'one. Every surface reads the database through a *-store.ts — which is what ' +
      ...
      // first version of this rule, which matched only the two import shapes.
      {
        ...
        message:
          ...
          'file. Only lib/app/content/seed-input/**, prisma/seeds/** and tests may ' +
          'import one. See lib/app/content/index.ts.',
      },
      {
