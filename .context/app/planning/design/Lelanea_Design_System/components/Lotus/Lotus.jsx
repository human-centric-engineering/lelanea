...
export function Lotus({ size = 140, open: openProp, autoOpen = true, idle = true, water = true, delay = 0, onOpened }) {
  ...
  return (
    <div style={{
      ...
      <svg width={frameW} height={frameH} viewBox={f.box} style={{ position: 'relative', overflow: 'visible' }}>
        <defs>
          <radialGradient id={`lotus-core-${uid}`} cx="50%" cy="42%" r="60%">
        ...
        <ellipse cx="160" cy={LOTUS_CORE_CY} rx="8" ry="10" fill={`url(#lotus-core-${uid})`} style={{
